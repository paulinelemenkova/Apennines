...
r.import input=/Users/polinalemenkova/grassdata/Italy/LC09_L2SP_191030_20231003_20231004_02_T1_SR_B1.TIF output=L_2023a_01 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Italy/LC09_L2SP_191030_20231003_20231004_02_T1_SR_B2.TIF output=L_2023a_02 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Italy/LC09_L2SP_191030_20231003_20231004_02_T1_SR_B3.TIF output=L_2023a_03 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Italy/LC09_L2SP_191030_20231003_20231004_02_T1_SR_B4.TIF output=L_2023a_04 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Italy/LC09_L2SP_191030_20231003_20231004_02_T1_SR_B5.TIF output=L_2023a_05 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Italy/LC09_L2SP_191030_20231003_20231004_02_T1_SR_B6.TIF output=L_2023a_06 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Italy/LC09_L2SP_191030_20231003_20231004_02_T1_SR_B7.TIF output=L_2023a_07 extent=region resolution=region
#
g.list rast
...
g.region raster=L_2023a_01 -p
i.group group=L_2023a subgroup=res_30m \
  input=L_2023a_01,L_2023a_02,L_2023a_03,L_2023a_04,L_2023a_05,L_2023a_06,L_2023a_07 --overwrite
#
...
i.maxlik group=L_2023a subgroup=res_30m \
  signaturefile=cluster_L_2023a \
  output=L_2023a_clusters reject=L_2023a_cluster_reject --overwrite
#
r.colors L_2023a_clusters color=roygbiv
#
# Mapping
g.region raster=L_2023a_01 -p
d.mon wx0
d.rast L_2023a_clusters
d.grid -g size=00:30:00 color=grey width=0.1 fontsize=16 text_color=grey
d.legend raster=L_2023a_clusters title="Clusters 2023" title_fontsize=19 font="Helvetica" fontsize=17 bgcolor=white border_color=white
d.out.file output=Italy_2023 format=jpg --overwrite
#
# Mapping rejection probability
d.mon wx0
g.region raster=L_2023a_clusters -p
r.colors L_2023a_cluster_reject color=soilmoisture -e
d.rast L_2023a_cluster_reject
d.grid -g size=00:30:00 color=grey width=0.1 fontsize=16 text_color=grey
d.legend raster=L_2023a_cluster_reject title="2023" title_fontsize=19 font="Helvetica" fontsize=17 bgcolor=white border_color=white
d.out.file output=Italy_2023_reject format=jpg --overwrite
#
# --------------------- MACHINE LEARNING ------------------------>
# Generating training pixels from the land cover classification:
#r.random input=L_2023a_clusters seed=100 npoints=1000 raster=training_pixels --overwrite
...
r.learn.predict group=L_2023a load_model=rf_model.gz output=rf_classification --overwrite
# display
...
# perform prediction using r.learn.predict
r.learn.predict group=L_2023a load_model=mlpc_model.gz output=mlpc_classification --overwrite
# display
