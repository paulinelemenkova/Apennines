...
r.import input=/Users/polinalemenkova/grassdata/Italy/LC08_L2SP_191030_20180420_20200901_02_T1_SR_B1.TIF output=L_2018_01 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Italy/LC08_L2SP_191030_20180420_20200901_02_T1_SR_B2.TIF output=L_2018_02 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Italy/LC08_L2SP_191030_20180420_20200901_02_T1_SR_B3.TIF output=L_2018_03 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Italy/LC08_L2SP_191030_20180420_20200901_02_T1_SR_B4.TIF output=L_2018_04 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Italy/LC08_L2SP_191030_20180420_20200901_02_T1_SR_B5.TIF output=L_2018_05 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Italy/LC08_L2SP_191030_20180420_20200901_02_T1_SR_B6.TIF output=L_2018_06 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Italy/LC08_L2SP_191030_20180420_20200901_02_T1_SR_B7.TIF output=L_2018_07 extent=region resolution=region
#
g.list rast
...
#
r.colors L_2018_clusters color=roygbiv
#
# Mapping
g.region raster=L_2018_01 -p
d.mon wx0
...
r.colors L_2018_cluster_reject color=soilmoisture -e
...
r.random input=L_2018_clusters seed=100 npoints=1000 raster=training_pixels --overwrite
...
r.learn.predict group=L_2018 load_model=rf_model.gz output=rf_classification --overwrite
...
d.out.file output=RF_2018 format=jpg --overwrite
# ------------------------<
...
# perform prediction using r.learn.predict
r.learn.predict group=L_2018 load_model=dtc_model.gz output=dtc_classification --overwrite
# display
...
# perform prediction using r.learn.predict
r.learn.predict group=L_2018 load_model=mlpc_model.gz output=mlpc_classification --overwrite
